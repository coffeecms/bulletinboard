...
function bb_account_get_list_hidebb_received_payment()
{
    ...
    $queryStr.=" left join user_mst as b ON a.buyer_id=b.user_id";
    $queryStr.=" left join bb_threads_data as c ON a.post_id=c.thread_id";
    $queryStr.=" where a.seller_id='".Configs::$_['user_data']['user_id']."' AND a.data_type='thread'";
    $queryStr.=" union ";
    ...
    $queryStr.=" where a.seller_id='".Configs::$_['user_data']['user_id']."' AND a.data_type='post'";
