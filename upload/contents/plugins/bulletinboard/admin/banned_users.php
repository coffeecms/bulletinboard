...
if(!isset(Configs::$_['user_permissions']['BB30019']))
{
  redirect_to(SITE_URL.'admin/notfound');
    ...
    $listData=$db->query("select * from bb_banned_user_data where data_method='username' order by ent_dt desc");
      ...
      <div class="container-fluid">
        ...
        <div class="row">
              ...
              <div class="card-header border-0">
                <h3 class="card-title"><?php echo get_text_by_lang('Banned Username','admin');?></h3>
...
$(document).on('click','.btnApply',function(){
  ...
  postData(API_URL+'plugin_api?plugin=bulletinboard&func=bb_banned_username_action_apply', sendData).then(data => {
    // console.log(data); // JSON data parsed by `data.json()` call
