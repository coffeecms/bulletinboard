  ...
  <div class='container   mt-20px pl-0px pr-0px'>
    ...
    <div style="margin:0px;padding:0px;min-width: 280px;min-height:90px;max-width: 280px;max-height:140px;background-color: #2885BF;color:#ffffff;border-radius: 3px;padding:3px;position: relative;">
                ...
                <div class='row margin-top-20'>
                  ...
                  <button type='button' class='btn btn-success btnLogin'><i class='fas fa-key'></i> Login</button>
                  </div>                    
                </div>
                <!-- row -->
...
function KeyCheck(e) {
    ...
    var jsonData={};
      ...
      postData(API_URL+'plugin_api?plugin=bulletinboard&func=frontend_api&api_nm=user_login', jsonData).then(data => {
